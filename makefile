...
CFLAGS = -Wall -I/usr/x86_64-w64-mingw32/include/ -I./external/SDL2 -mwindows
LFLAGS = -lws2_32 -lole32 -lgdi32 -luuid -static-libgcc -static-libstdc++ -lshlwapi -L./libs -lSDL2 -lSDL2_image -lSDL2_mixer
...
.PHONY: directories clean all post-build zip
...
zip: KV-RAT post-build
	zip -r $(BUILD_DIR)/KV-RAT_archive.zip $(BUILD_DIR)/KV-RAT.exe $(BUILD_DIR)/*.dll $(BUILD_DIR)/assets/* $(BUILD_DIR)/start.bat
